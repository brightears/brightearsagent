...
export default async function AssistantPage(){
 ...
 <p>{th?"Bright Ears กลับมาเน้นบริการดีเจเอเจนซี และยุติระบบผู้ช่วย การค้นหาอัตโนมัติ การร่าง และการส่งอีเมลแล้ว":"Bright Ears is focusing on its DJ agency. The artist assistant has been retired. Automated discovery, drafting, replies and emails have stopped."}</p>
