...
export async function generateDraftForLead(
  ...
  const req: DraftRequest = {
    business: {
      ...
      voiceGreeting: lead.business.voiceGreeting,
      voiceSignoff: lead.business.voiceSignoff,
      voiceUsesEmoji: lead.business.voiceUsesEmoji,
      voicePhrases: lead.business.voicePhrases,
