...
- [ ] 10.2 Venue engine — discovery: Venue + VenueSignal models; per-metro signal scanners (new-opening roundups/local news via search API 🔑, new Maps-class listings, venue hiring posts) + standing-venue indexing (bars/hotels/event spaces matching act+geo+fee profile); freshness/heat scoring
- [ ] 10.3 Venue engine — contact + pitch: published booking/events contact discovery (venue site/Google Business/press ONLY; LinkedIn = find-only handoff card); pitch drafting in artist voice + EPK link, venue-type + culture/language aware; jurisdiction rules engine (recipient-country: US/UK/TH standard, CA consent-mode, DE strict); caps 10-20/day, suppression, dedup, C&D kill switch
- [ ] 10.4 Opportunity feed: one home feed, venue cards + inbound cards with source badges ("I found this venue" / "Came to you"); fit score + ≤3 plain reasons + 1 caution; Approve/Edit/Skip (Skip asks why → tunes matching); morning digest incl. skipped-list; FOUND→PITCHED→(reply)→existing pipeline statuses
