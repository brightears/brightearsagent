...
- [ ] 10.1 Profile/EPK expansion: matching fields (genres/vibe tags, event types, service radius/cities, travel policy, fee floor + sweet spot, languages, insured), pitching fields (headline, short bio, video links, photos, review quotes), auto-generated hosted one-page EPK (white-label, zero AI mention) — the pitch's landing page; "hunting license" quality gate — agent may FIND with 4 fields, may not PITCH until video+photos+bio+packages+calendar
