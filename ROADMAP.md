...
- [ ] 10.5 Own-mailbox sending: Gmail/Microsoft OAuth onboarding step (easy guided flow), SPF/DKIM/DMARC check before agent may send, recipient-local send windows
